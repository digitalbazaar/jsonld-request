 ...
 *
 * @param {string} loc - Location string came from.
 * @param {string} type - Content type of the string.
 ...
 * Parse data.
 *
 * @param {string} loc - Location the data came from.
 * @param {string|null} type - Content type of the string or null to attempt
 *   to auto-detect.
 * @param {string} data - The data to parse.
 *
 ...
 * @param {string|false} [options.dataType = false] - Data type to expect and
